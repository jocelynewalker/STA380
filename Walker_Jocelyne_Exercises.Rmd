...
* We must consider the **time value of money.** Performing an NPV analysis and talking to the construction company about reducing the cost of the project will supplement the analysis. 

First, instead of dropping all buildings with leasing rates less than 10%, I chose to drop only those with leasing rates less than 1% to consider more of the outliers. 
...
par(mfrow=c(6,3))
ggplot(green, aes(x = as.factor(green_rating), y = size)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Size") +
...
ggplot(green, aes(x = as.factor(green_rating), y = empl_gr)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
...
ggplot(green, aes(x = as.factor(green_rating), y = Rent)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Rent") +
...
ggplot(green, aes(x = as.factor(green_rating), y = leasing_rate)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Leasing Rate") +
...
ggplot(green, aes(x = as.factor(green_rating), y = stories)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Stories") +
...
ggplot(green, aes(x = as.factor(green_rating), y = age)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Age") +
...
ggplot(green, aes(x = as.factor(green_rating), y = renovated)) + 
  geom_boxplot() + 
  xlab("Renovated") +
...
ggplot(green, aes(x = as.factor(green_rating), y = class_a)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Class A") +
...
ggplot(green, aes(x = as.factor(green_rating), y = class_b)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Class B") +
...
ggplot(green, aes(x = as.factor(green_rating), y = net)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Net") +
...
ggplot(green, aes(x = as.factor(green_rating), y = amenities)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Amenities") +
...
ggplot(green, aes(x = as.factor(green_rating), y = cd_total_07)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
...
ggplot(green, aes(x = as.factor(green_rating), y = hd_total07)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
...
ggplot(green, aes(x = as.factor(green_rating), y = total_dd_07)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
...
ggplot(green, aes(x = as.factor(green_rating), y = Precipitation)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Precipitation") +
...
ggplot(green, aes(x = as.factor(green_rating), y = Gas_Costs)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Gas Costs") +
...
ggplot(green, aes(x = as.factor(green_rating), y = Electricity_Costs)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
...
ggplot(green, aes(x = as.factor(green_rating), y = cluster_rent)) + 
  geom_boxplot() + 
  xlab("Green Rating") + 
  ylab("Cluster Rent") +
